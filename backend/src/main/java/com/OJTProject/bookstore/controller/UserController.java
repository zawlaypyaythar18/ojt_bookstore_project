...
public class UserController {
	...
	private ResponseEntity<?> addNewShippingAddress(@RequestBody UserAddress userAddress, @RequestParam("currentUserId") Long currentUserId) {
	...
	private ResponseEntity<?> updateShippingAddress(@RequestBody UserAddress userAddress, @RequestParam("currentUserId") Long currentUserId) {
	...
	private ResponseEntity<?> addNewCreditCard(@RequestBody UserBillingPayment userBillPayment, @RequestParam("currentUserId") Long currentUserId) {
	...
	private ResponseEntity<?> updateCreditCard(@RequestBody UserBillingPayment userBillPayment, @RequestParam("currentUserId") Long currentUserId) {
